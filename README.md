...
A rota `/conhecimentos` permite:

### Filtrar por categoria

```
GET /conhecimentos?categoria=tecnologia
```

### Filtrar por nível

```
GET /conhecimentos?nivel=basico
```

### Combinar filtros

```
GET /conhecimentos?categoria=tecnologia&nivel=basico
```

### Buscar por palavra-chave

```
GET /conhecimentos?busca=react
```
